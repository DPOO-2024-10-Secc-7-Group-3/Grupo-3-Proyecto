...
public class Fotografia extends Imagen {

	public Fotografia(String titulo, int anio, String lugarCreacion, String estado, int tiempoConsignacion,
		...
		super(titulo, anio, lugarCreacion, estado, tiempoConsignacion, disponibilidad, bloqueada, valorMinimo,
				valorInicial, propietario, ancho, alto, resolucion);
